...
public class PlotActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        ECGModel ecgSeries = new ECGModel(500, 80);
...
//        threadstep.start();
    ...
    public static class ECGModel implements XYSeries {
        ...
        private int i=1;
        private double dataindex1=0;
        private double dataindex11=0;
        /**
         *
                ...
                public void run() {
                    try {
                        ...
                        while (keepRunning) {
                            ...
                            if(i==1)
                            {
                                dataindex1 = MainActivity.getData()[0];
                            }
                            if (i < 11)
                            {
                                data[latestIndex] = MainActivity.getData()[i];
                                i++;
                                latestIndex++;
                            }
                            else
                            {
                                dataindex11 = MainActivity.getData()[0];
                                if(dataindex11!=dataindex1)
                                {
                                    i=1;
                                }
