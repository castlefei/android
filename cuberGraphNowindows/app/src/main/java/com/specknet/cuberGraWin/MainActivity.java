...
//    private static final String ORIENT_BLE_ADDRESS = "DA:26:F7:87:FA:38";
    ...
    private static double lastPcaData = 0;
    private static double data0 = 0;
    private static double data1 = 0;
    private static double data2 = 0;
    private static double data3 = 0;
    private static double data4 = 0;
    private static double data5 = 0;
    private static double data6 = 0;
    private static double data7 = 0;
    private static double data8 = 0;
    private static double data9 = 0;
    private static double data10 = 0;
...
//    }
    ...
    private void handleRawPacket(final byte[] bytes) {
        ...
        String[] titles = "timestamp#seq#accel_x#accel_y#accel_z#gyro_x#gyro_y#gyro_z".split("#");
        packetData.clear();
        packetData.put(bytes);
        packetData.position(0);
...
//                        PyObject obj3 = mod.callAttr("count_peaks", threshold);
...
//                        lastPcaData = Double.parseDouble(peaks_threshold[2]);
//                        data0 = Double.parseDouble(peaks_threshold[2]);
                        data0++;
                        data1 = Double.parseDouble(peaks_threshold[2]);
                        data2 = Double.parseDouble(peaks_threshold[3]);
                        data3 = Double.parseDouble(peaks_threshold[4]);
                        data4 = Double.parseDouble(peaks_threshold[5]);
                        data5 = Double.parseDouble(peaks_threshold[6]);
                        data6 = Double.parseDouble(peaks_threshold[7]);
                        data7 = Double.parseDouble(peaks_threshold[8]);
                        data8 = Double.parseDouble(peaks_threshold[9]);
                        data9 = Double.parseDouble(peaks_threshold[10]);
                        data10 = Double.parseDouble(peaks_threshold[11]);

                        stepsCount += peaks;

                        writer_temp = new CSVWriter(new FileWriter(file_temp), ',');

                        writer_temp.writeNext(titles);
...
//            }
    ...
    {
        double[] data_arr = {data0,data1,data2,data3,data4,data5,data6,data6,data7,data8,data9,data10};
        return data_arr;
    }
